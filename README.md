...
`npm run benchmark` in [`benches/`](benches/).
...
[the compatibility guide](hypertok-js/SHIMS.md).
...
The harness in [`benches/`](benches/) measures browser and Node behavior on English, Chinese,
...
![speed vs resident memory, GPT-2 long document](assets/pareto-speed-memory.png)
